...
public class GreetingServiceTest extends AbstractTest {
	...
	// Esegue della logica prima di ogni @Test della classe ( E' un Before Each per intendersi )
	@Before
	public void setUp() {
		
		// serve perchè l'ordine di esecuzione dei test non è predicibile,
		// dato che c'è un sistema di caching attivo è meglio pulire ad ogni test 
	...
	public void testCreateWithId() {
		...
		Assert.assertTrue("failure - expected instance of EntityExistsException", e instanceof EntityExistsException);
	}
	...
	public void testUpdateNotFound() {
		...
		Assert.assertTrue("failure - expected exception to be instance of NoResultException", e instanceof NoResultException);
	}
