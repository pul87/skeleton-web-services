...
public class GreetingControllerTest extends AbstractControllerTest {
    ...
    public void testCreateGreeting() throws Exception {
        ...
        MvcResult result = mvc.perform(MockMvcRequestBuilders.post(uri).accept(MediaType.APPLICATION_JSON)
    ...
    public void testUpdateGreeting() throws Exception {
        ...
        MvcResult result = mvc.perform(MockMvcRequestBuilders.put(uri, id).accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON).content(inputJson)).andReturn();
