...
public class GreetingsControllerMocksTest extends AbstractControllerTest {
    ...
    @Mock // dice a mockito di analizzare l'interfaccia e di creare un mock con
    // gli stessi metodi pubblici
    ...
    @Before
    public void setup() {
        // inizializzazione di mockito, cerca le proprie annotazioni e
        // inizializza gli oggetti
        MockitoAnnotations.initMocks(this);
        // A questo punto il controller corrente ha le mock e sono
        // inizializzate, eseguo il setup
    ...
    public void testCreateGreeting() throws Exception {
        ...
        MvcResult result = mvc.perform(MockMvcRequestBuilders.post(uri).content(inputJson)
    ...
    public void testUpdateGreeting() throws Exception {
        ...
        MvcResult result = mvc.perform(MockMvcRequestBuilders.put(uri, greeting.getId()).content(inputJson)
                .accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON)).andReturn();
